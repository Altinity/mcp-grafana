...
require (
	...
	github.com/BorisTyshkevich/go-mcp-oauth v0.0.0-00010101000000-000000000000
...
// Local checkout while mcp-oauth is iterated alongside grafana-mcp.
// Drop once the library has a tagged release.
replace github.com/BorisTyshkevich/go-mcp-oauth => ../mcp-oauth
